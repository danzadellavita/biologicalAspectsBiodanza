...
This work is shared under the CC BY-NC-SA 4.0 licence on 14 September, 2023.
...
``Holography'' is a technique to record a three dimensional image of an object on a two dimensional photographic plate. When a hologram is illuminated in a suitable way, the 3D image can be reconstructed. Even when holographic record is broken into parts, the 3D image can be reconstructed from each part, albeit with a smaller resolution. Each part of the hologram contains thus information on the whole!
