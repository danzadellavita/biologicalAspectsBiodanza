...
This work is shared under the CC BY-NC-SA 4.0 licence on 11 December, 2023.
...
At the end of his life, Rolando, introduced the numinous unconsciousness, with which he referred to our greatness and sacredness. We can develop our numinous unconsciousness by connecting with love and life. Through our vivencia of love and life, we can get enlightened, which can give us the courage to face our shadows, embrace them, and transmute them in order to experience intacy. The latter refers to interior ecstacy that gives access to the vivencia of experiencing the cosmic force within us and to feel oneness with the universe, which makes it so obvious to take care of all beauty in nature that is surrounding us.\\
When practicing Biodanza on a longer term we stimulate our genetic potential towards integration and connectedness with ourselves, our species, life as a whole, and with our greatness, which Rolando referred to with the metaphor ``the cosmic human''.
...
The structure that spontaneously emerges in living organisms is thus not violating the second law because of the rise in entropy by the dissipation of heat, \emph{which again shows how the processes of anabasis and catabasis go hand in hand.}
...
\emph{The Dictyostelium example also clearly shows how hard-wired and precise instincts are shaped, and how closely they are linked to the biochemistry of an organism. We can recognize the instincts of }

\begin{itemize}
\tightlist
\item
  \emph{exploration in the free living amoebae}
\item
  \emph{tropism when all amoebae turn and start to move in the direction of the cAMP cue}
\item
  \emph{conservation, solidarity and sexuality when they organize themselves in a fruiting body.}
\end{itemize}
...
\emph{According to him life} is the synergy of these three domains, which he refers to as the embodied mind.

\emph{Interestingly, Rolando sees life as the organizing principle of the universe. So, in his view life can be seen as the creative force that is developing an ever evolving gestalt of environment, autopoietic units, and cognition.}
...
\emph{The Eukaryota further evolved in protists, which are unicellular organisms, fungae, plants and animals.}
\emph{Margulis SET theory also supports a more intuitive organisation of the tree of live into a two part (eukaryotic vs prokaryotic) five kingdom taxonomy that reflects evolutionary history, see Figure \ref{fig:fiveKingdoms}: Prokaryotic bacteria and archae-bacteria evolved in eukaryotic Protista that further evolved into Plants, Fungae and animals.}
...
\emph{Margulis' take on this is nicely summarised in the following quote: ``more complex multicellular organisms such as fungi, plants and animals can be seen as a massive colony of differentiated fused and mutating symbiotic microorganisms'' \citep{margulis1999}.}

So, all these \emph{arguments} make clear that evolution has no direction.
Instead, we can view evolution as a wonderful creative process that is generating novel life forms that are well adapted to their ever changing environment. \emph{So this insight on evolution invites us to deeply embrace the wealth of diversity, instead.}
