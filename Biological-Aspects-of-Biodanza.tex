...
Indeed, when glaciers pull back lichens appear on the bare in hostile rocks and in the course of thousands of year they can convert these rocks into an environment that is fertile for other species. However, their unique and important properties for life on earth could never have been expected when studying a lichens components.
...
Indeed, as \citet{Kimmerer2013} points out so convincingly in her book Braiding Sweetgrass, it also invites us to learn from all forms of life that are surrounding us. For her, the lichens for example can teach us how reciprocity in a relationship can lead to a unique partnership where the whole is more then its parts. Lichens are all about the dynamic balance of asking, gracefully accepting and giving. Indeed, in order for the green alga to migrate from the ocean to colonize land it asks the fungus for a shelter from UV light, a structure to retain water and to extract minerals from hard rocks. The fungus happily embraces the green alga with its shelter and provides it with minerals that it can mine from the rocks. So the fungus shapes the environment where the green algae can turn air and light into sugars. However, the fungus needs to ask the algae sugars for its own survival and the algae give upto 50\% of the produced sugars to the fungus in return. This unique partnership let them both thrive in these harsh environments that they could never colonize on their own, and from their shared lives the whole ecosystem benefits. \citet{Kimmerer2013} translates this to our symbolic realm, and argues that a good partner relationship ``is also a balance of giving, asking and receiving, where the roles of the giver and receiver are shifting from moment to moment. It is also a commitment to an''us'' that emerges from the strengths and the weaknesses of the partners, an ``us'' that extends well beyond the boundaries of coupledom into their family and community''.
...
This is due to epigenetics! And, epigenetics is also the missing link that Rolando Toro needed to understand and explain how Biodanza can provide an enriched environment that induces organic and cellular renewal, affective re-education and relearning of the original functions of life.
...
Another twins study also showed an association between physical exercise and epigenetic markers associated with a reduced development of metabolic syndrome \citep{Duncan2022}.
