...
One of the key drivers for Rolando Toro to develop his System of Biodanza was the disconnection he observed of men and women from the cosmic matrix, throughout our Western history, which has generated destructive cultural forms. This resulted from our Cartesian way of thinking, which caused a fragmented view of life. Indeed, it implied a division between living matter and non-living matter, body and soul, humanity and nature, and it considers the universe as being analyzable in separately existing parts that more or less interact as parts of a machine \citep{bohm1980}. This fragmented world view disconnected us from the universe that we inhabit and broke up our human society into distinct religious, political, economical and racial groups, among others leading to the exploitation of our natural resources, plants, animals and of fellow humans.
...
{\centering \includegraphics[width=0.45\linewidth]{./figs/holograph-record} \includegraphics[width=0.45\linewidth]{./figs/Holography-reconstruction} 
...
In the following sections we will explore what de Duve meant with each component in his definition. Note, that each section starts with the key idea and then consists of more technical subsections that introduce the biological concepts in the reader ``Module IV Biological aspects of Biodanza'' in more detail. So readers who would like to skip these technical details can easily jump between the introductions of 2.3.1. life is one, 2.3.2. life is chemistry and 2.3.3 life is information, while skipping the lower and more detailed subsections.
