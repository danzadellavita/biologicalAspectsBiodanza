...
Note, that the example of the seed also shows how powerful the concept is of an enriched environment. This was exactly what Rolando intended with Biodanza: providing an enriched environment that can influence our ontogenesis, i.e.~how its ecofactors can trigger our growth and development as a human being and this both on a physiological and psycho-socio-emotional level.
